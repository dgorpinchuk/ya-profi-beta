...
## Онлайн-редактор, позволяющий легко получить необходимый текст с синтаксисом MD: 
[https://stackedit.io](https://stackedit.io/app#)

### Краткое руководство по оформлению постов на языке Markdown
...
Заголовки отмечаются символом `#` в начале строки, от одного до шести. Например:
...
![Alt text](//public/image/name.jpg "Можно задать title")
...
[image1]: //public/image/name1.jpg
[image2]: //public/image/name2.jpg
[image3]: //public/image/name3.jpg
Картинки-ссылки:

[![Alt text](//public/image/name.jpg)](http://example.com/)
